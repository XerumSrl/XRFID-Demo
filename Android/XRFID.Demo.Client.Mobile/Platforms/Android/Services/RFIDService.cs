...
using XRFID.Demo.Client.Mobile.Data;
...
public class RFIDService : Java.Lang.Object, Readers.IRFIDReaderEventHandler, IRfidEventsListener, IRFIDService
{
    ...
    public bool AddFilter(PreFilters.PreFilter preFilter)
    {
        try
        {
            rfidReader.Actions.PreFilters.Add(preFilter);
            return true;
        }
        catch (Exception)
        {
    ...
    public short[] GetAntennas()
    {
        return rfidReader.Config.Antennas.GetAvailableAntennas();
    }

    public Antennas.SingulationControl GetSingulation(short antennaId)
    {
        return rfidReader.Config.Antennas.GetSingulationControl(antennaId);
    }

    public void SetSingulation(short antennaId, Antennas.SingulationControl singulationControl)
    {
        rfidReader.Config.Antennas.SetSingulationControl(antennaId, singulationControl);
    }

    public PreFilters GetFilters()
    {

        return rfidReader.Actions.PreFilters;
    }

    public void SetFilters(PreFilters preFilters)
    {
        rfidReader.Actions.PreFilters = preFilters;
    }

    public bool RemoveFilter(PreFilters.PreFilter preFilter)
    {
        try
        {
            rfidReader.Actions.PreFilters.Delete(preFilter);
            return true;
        }
        catch (Exception ex)
        {
