...
namespace XRFID.Server.Demo.V2.Migrations
{
    ...
    [Migration("20241028095704_ProductSkuReference")]
    partial class ProductSkuReference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XRFID.Server.Demo.V2.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("SkuReference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("XRFID.Server.Demo.V2.Entities.Reader", b =>
                {
                    b.HasOne("XRFID.Server.Demo.V2.Entities.Location", "Location")
                        .WithMany("Readers")
                        .HasForeignKey("LocationId");
