...
public class GpioDataConsumerDefinition : ConsumerDefinition<GpioDataConsumer>
{
    ...
    protected override void ConfigureConsumer(IReceiveEndpointConfigurator endpointConfigurator, IConsumerConfigurator<GpioDataConsumer> consumerConfigurator, IRegistrationContext context)
    {
