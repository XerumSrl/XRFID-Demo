...
public class ReaderController : ControllerBase
{
    ...
    public async Task<IActionResult> PostMinimalAsync(MinimalReaderCreateDto minimalReaderCreateDto)
    {
        ...
        {
            response = _responseDataFactory.BadRequest(minimalReaderCreateDto, ex.Message);
        }
        catch (NotImplementedException ex)
        {
            response = _responseDataFactory.NotImplemented(minimalReaderCreateDto, ex.Message);
        }
        catch (Exception ex)
        {
            response = _responseDataFactory.InternalError(minimalReaderCreateDto, ex.Message);
        }
